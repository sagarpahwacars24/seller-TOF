...
//    private static final String ENDPOINT = "/lead-details/{token}";
    ...
    public static Response appointmentDetailByToken() {
    	 RestAssured.baseURI = BASE_URI;
    	 BookAppointment.appointmentConfirm();
    	 String token = TokenManager.getToken();
    	 String ENDPOINT = String.format("/appointment/token/%s", token);
