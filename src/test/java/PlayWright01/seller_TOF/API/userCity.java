...
public class userCity {
		...
		private static final String BASE_URI = "https://stage-car-catalog-gateway-in.qac24svc.dev";
    private static final String ENDPOINT = "/api/v1/city";
    ...
    public static Response makeUserCity() {
